<template  >
  ...
  <main class="profile-fon pb-5">
    ...
    <div
      class="d-flex justify-content-between m5-l-r align-items-center pb-4 pt-3"
    >
          ...
          <div class="col-md-8">
            <div class="card mb-3 boder-shodow-radius">
                ...
                <div class="row">
                  <div class="col-sm-12 d-flex-wrap-gap">
                   ...
                   <img src="../../../static/img/floppy-disk.png" height="40" />
                    ...
                    <router-link class="btn  " :to="'/user/' + id"
                      >
             <img src="../../../static/img/id-card.png"  height="60"/>
              ...
              <router-link class="btn btn-primary" v-if="admin" to="/admin"
                >кабинет админа</router-link
              >
            </div>
          </div>
        </div>
    ...
    <div
      ...
      class="accordion m5-l-r mb-3 boder-shodow-radius"
    ...
    >
      ...
      >
        ...
        <div
          :id="'panelsStayOpen-collapseThree' + i"
        ...
        >
          <div class="accordion-body books d-flex-wrap">
            <Book
              :item="item"
              :collection="true"
              v-for="(item, id) in collection.books"
              :key="id"
            />
          </div>
        </div>
