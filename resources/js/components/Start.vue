<template>
  <header
    class="header_menu"
    v-show="$route.name != 'NotFound' && $route.name != 'Admin'"
  >
    ...
    <div class="menu m5-l-r">
      ...
      <div class="menu_item">
        ...
        <div class="menu_item_cart">
          ...
          <p
            :style="{ backgroundColor: couterCartBacground }"
            id="cartidlenthe"
          >
  ...
  <div class="cntmain">
    ...
    <div
      v-if="!($route.name == 'NotFound' || $route.name == 'ChatBook')"
    ...
    >
      ...
      >
        ...
        <ul class="nav col-md-4 justify-content-end">
          ...
          <li class="nav-item">
            <router-link to="/books" class="nav-link px-2 text-light"
              >Books</router-link
            >
          </li>
          <li class="nav-item">
            <router-link to="/profile" class="nav-link px-2 text-light"
              >Personal account</router-link
            >
          </li>
          <li class="nav-item">
            <router-link to="/favourites" class="nav-link px-2 text-light"
              >Favourites</router-link
            >
          </li>
          <li class="nav-item">
            <router-link to="/about" class="nav-link px-2 text-light"
              >About</router-link
            >
          </li>
          <li class="nav-item">
            <router-link to="/404" class="nav-link px-2 text-light"
  ...
  <div class="menumobile">
    ...
    <router-link
      to="/books"
      class="menumobileItem"
      :class="{ active_menu: $route.path == '/books' }"
    >
    ...
    <router-link
      to="/search?query="
      class="menumobileItem"
      :class="{ active_menu: $route.path == '/search' }"
    >
    ...
    <router-link
      to="/profile"
      class="menumobileItem"
      :class="{ active_menu: $route.path == '/profile' }"
    >
    ...
    <router-link
      to="/favourites"
      class="menumobileItem"
      :class="{ active_menu: $route.path == '/favourites' }"
    >
