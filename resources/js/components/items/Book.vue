<template>
  <InfoItem
    :closeInfo="newUserBookfaloverClose"
    v-if="newUserBookfalover"
    :title="'Здравствуйте!'"
    :textbody="' Все отмеченные книги, будут находиться на странице избранное'"
    :textbody2="''"
  />
  <div class="Book">
    <div>
    ...
    <div class="BookCnt">
      ...
      <button
        ...
        @click="$router.push('/Bookadout/' + item.genre + '/' + item.id)"
      >
        Открыть
      </button>
      <img
